/*
#파일명 : YANAproject.ino
#개발환경 : Arduino IDE ver. 1.6.0
#개발기간 : 2014.04.01 ~ 2014.11.30
#프로젝트명 : Silver세대를 위한 Life Management System
#팀명 : YANA (You Are Not Alone)
#멘토 : 삼성전자 무선사업부 임요왕
#멘티 : 인천대학교 임승한
        인천대학교 권상희
        인천대학교 임미리
...
- 조도센서
+ Android Application
#프로젝트 영상 : https://www.youtube.com/watch?v=J71-gAI3XXQ
*/
#include <SPI.h>
#include <WiFi.h>
//RFID Tag Code
